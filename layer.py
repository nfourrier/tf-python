...
class bn(Layer):
    def setup(self,inp,scope):
        ...
        self.out = tf.nn.batch_normalization(
            x=inpOp,
            mean=mean,
            variance=var,
            offset=beta,
        ...
        self.weights = [beta,gamma,mean,var]
...
layers = {
    ...
    'res_block': res_block,
    'inception': inception_layer,
    'crosslrn': cross_map_lrn_layer,
    'lppool':lp_pool_layer,
